...
<body>
    <div class="offcanvas-lg offcanvas-start" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        <div class="offcanvas-header d-lg-none">
            <h5 class="offcanvas-title text-dark" id="sidebarMenuLabel">Student Menu</h5>
        ...
        <!-- <div class="offcanvas-body p-0"> -->
            ...
            <div class="sidebar">
                ...
                <div class="modal fade" id="updatePhotoModal" tabindex="-1" aria-labelledby="updatePhotoLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form action="../includes/student_update_photo.php" method="post" enctype="multipart/form-data" id="updatePhotoForm">
                ...
                <a href="profile_update.php" class="<?php echo $current_page == 'profile_update.php' ? 'active' : ''; ?>">
                    <i class="fas fa-user-edit me-2"></i>Profile Update
                </a>
                <a href="apply_placements.php" class="<?php echo $current_page == 'apply_placements.php' ? 'active' : ''; ?>">
                    <i class="fas fa-briefcase me-2"></i>Available Placement Drives
                </a>
                <a href="raise_issue.php" class="<?php echo $current_page == 'raise_issue.php' ? 'active' : ''; ?>">
                    <i class="fas fa-exclamation-circle me-2"></i>Issue Raise
                </a>
                <a href="view_notifs.php" class="<?php echo $current_page == 'view_notifs.php' ? 'active' : ''; ?>">
                    <i class="fas fa-bell me-2"></i>Notifications
                </a>
                <a href="../includes/logout.php?logout=student">
